...
public class ClienteService {
	...
	public void guardaCliente(String cedula, String nombres, String apellidos, 
		...
		if(Validaciones.isTextoVacio(cedula)){
			throw new IWServiceException("La cédula del cliente no puede ser nula, ni una cadena de caracteres vacia");
		}
		...
		if(Validaciones.isTextoVacio(correoElectronico)){
			throw new IWServiceException("El correo electrónico del cliente no puede ser nula, ni una cadena de caracteres vacia");
		}
	...
	public Cliente obtener(String cedula) throws IWDaoException, IWServiceException{
		if(cedula == null && "".equals(cedula)){
			throw new IWServiceException("La cédula del cliente a buscar no puede ser nula, ni una cadena de caracteres vacia");
		}
